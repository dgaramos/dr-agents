---
name: cody-executor
description: Cody DR entrypoint for executing an existing issue through the full plan, start, execute, and ship lifecycle in the resolved target repository.
skills:
  - plan-issue
  - start-issue
  - implement-issue
