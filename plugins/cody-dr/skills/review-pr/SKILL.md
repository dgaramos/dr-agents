...
If `<installed-plugin-root>` is unset, resolve the same file relative to this
...
publish-only invocation: `Publish the prepared Cody DR review manifest at <path> for <PR URL>.`
